...
Ja, du hast recht! Das Problem unten hat tatsächlich **mit der Interpretation der Koeffizienten als Faktoren (multiplikativ vs. additiv)** zu tun, nicht nur mit der Annahme der konstanten Variablen. Ich formuliere den gesamten Abschnitt jetzt so, dass er **präzise, verständlich und statistisch korrekt ist**:
